...
<div class="single">
	<div class="container">
		<div class="single-top wowload bounceInLeft" data-wow-delay="0.3s">
			<img class="img-responsive wowload fadeInUp animated" data-wow-delay=".5s" src="media/images/s10.jpg" alt="" />
				<div class="lone-line">
		...
		<div class="comment wowload bounceInRight" data-wow-delay="0.3s">
							<h3>Comments</h3>
							 <div class="media wowload fadeInLeft animated" data-wow-delay=".5s">
								<div class="code-in">
							    ...
							    <div class="media-left">
							        <a href="#">
							        	<img src="media/images/b2.png" alt="">
							        </a>
							     </div>
							    ...
							    <div class="media media-1 wowload fadeInUp animated" data-wow-delay=".5s">
								<div class="code-in">
							    ...
							    <div class="media-left">
							        <a href="#">
							        	<img src="media/images/b3.png" alt="">
							        </a>
							     </div>
							    <div class="media-body">
...
<!--								<div class="media wowload fadeInRight animated" data-wow-delay=".5s">
								<div class="code-in">
							    ...
							    <div class="media-left">
							        <a href="#">
							        	<img src="media/images/b4.png" alt="">
							        </a>
							     </div>
							    <div class="media-body">
		...
		<div class="leave wowload bounceInLeft" data-wow-delay="0.3s">
			<h2>Leave a comment</h2>
				<form>
					<div class="single-grid wowload fadeInLeft animated" data-wow-delay=".5s">
