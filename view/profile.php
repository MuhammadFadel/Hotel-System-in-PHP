        ...
        <div class="col-sm-9">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="settings">
                    ...
                    <hr>
                    <form class="form row" action="do_update_user.php" method="post" id="registrationForm">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                ...
                                <input type="text" name="nationality" class="form-control" id="location" value="<?php echo $_SESSION['user']['nationality'] ?>" placeholder="somewhere" title="enter a location">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                ...
                                <input type="text" class="form-control" name="phone" value="<?php echo $_SESSION['user']['phone']; ?>" id="mobile" placeholder="enter mobile number" title="enter your mobile number if any.">
                            </div>
                        </div>
